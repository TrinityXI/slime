...
#SBATCH --output=/work/projects/polyullm/slu/logs/stem/dedup/query-level/stage1/%j-%x.out
#SBATCH --error=/work/projects/polyullm/slu/logs/stem/dedup/query-level/stage1/%j-%x.err
...
# ========================================================
workdir=$(pwd)
tmp_dir=/lustre/projects/polyullm/slu/tmp/spark-${SLURM_JOB_ID}
cache_dir=/lustre/projects/polyullm/slu/tmp/chukonu_cache
